...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 22, 2022 lúc 01:09 PM
...
(7, 'Giới thiệu về JavaScript', 'Học JavaScript, một ngôn ngữ lập trình phát triển Web, để thêm tính tương tác cho các trang Web của bạn và trở thành một nhà phát triển Web chuyên nghiệp.', 480000, 'https://i.imgur.com/hWO0Mwv.png', '', 4, 2),
...
INSERT INTO `payment` (`paymentID`, `paymentFee`, `paymentTime`, `mota`, `studentID`, `courseID`) VALUES
(1, 350000, '2022-05-02', '', 5, 1),
(2, 400000, '2022-05-22', '', 7, 2),
(3, 340000, '2022-03-09', '', 7, 6),
(4, 420000, '2019-05-01', '', 7, 12),
(5, 210000, '2022-04-12', '', 5, 7),
(6, 460000, '2022-05-24', '', 8, 12),
(8, 460000, '2022-05-02', '', 4, 6);
...
(1, 'trung', '0968237823', 'hà nội', 'trung@gmail.com', '2012-05-02', 0, 4),
(2, 'hà', '0983827623', 'hà nam', 'ha@gmail.com', '2013-05-02', 300000, 6),
(4, 'lê văn tiến', '92379238', 'tủa chùa điện biên', 'tien@gmail.com', '2022-01-03', 0, 11),
(5, 'Quách Công Thành', '0924632832', 'Thái Bình', 'thanhquachtb@gmail.com', '2001-11-12', 3000000, 23),
(7, 'Nguyễn Văn Bình CNTT', '0968844313', 'điện biên', 'binh@gmail.com', '2022-05-01', 2000000, 24),
(8, 'đại học công nghiệp ', '1234', 'hà nội - việt nam', 'haui@gmail.com', '2022-05-20', 0, 25);
...
(1, 'Nguyễn Thị Yến', '0987237623', 'điện biên', 'nguyenyen@gmail.com', 5),
(2, 'Trần Quang Hải', '0987237777', 'hà nội', 'quanghai@gmail.com', 21);
