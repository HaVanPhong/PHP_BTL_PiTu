...
<?php
    ...
    if(empty($_SESSION['id_account'])){
        echo ' <script language="javascript">window.location="themtaikhoan.php"</script> ';
    }
    ...
    <form action="themsinhvien.php" method="post">
        <table align="center" class="them">
            ...
            <tr>    
                ...
                <td>
                    <input type="text" name="date_birth" value="<?php echo !empty($data['studentDate_Birth']) ? $data['studentDate_Birth'] : ''; ?>">
